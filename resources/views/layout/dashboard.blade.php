...
<html class="no-js h-100" lang="en">
  <head>
    ...
    <title>Universitas Airlangga | Dashboard</title>
  ...
  <body class="h-100">
    <div class="container-fluid">
      <div class="row">
        ...
        <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
          <div class="main-navbar">
            <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
              <a class="navbar-brand w-100 mr-0" href="#" style="background-color:rgb(218, 229, 248) line-height: 25px;">
        ...
        <!-- End Main Sidebar -->
        <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3" style="background-color:rgb(218, 229, 248)">
    ...
    <script src="{{ asset('assets/shards/scripts/app/app-blog-overview.1.1.0.js') }}"></script>
  </body>
</html>